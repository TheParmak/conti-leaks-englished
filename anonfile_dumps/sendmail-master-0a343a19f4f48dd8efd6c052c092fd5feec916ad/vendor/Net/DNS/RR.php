...
/* Include files {{{ */
require_once base_path('vendor/Net/DNS/RR/A.php');
require_once base_path('vendor/Net/DNS/RR/AAAA.php');
require_once base_path('vendor/Net/DNS/RR/NS.php');
require_once base_path('vendor/Net/DNS/RR/CNAME.php');
require_once base_path('vendor/Net/DNS/RR/PTR.php');
require_once base_path('vendor/Net/DNS/RR/SOA.php');
require_once base_path('vendor/Net/DNS/RR/MX.php');
require_once base_path('vendor/Net/DNS/RR/TSIG.php');
require_once base_path('vendor/Net/DNS/RR/TXT.php');
require_once base_path('vendor/Net/DNS/RR/HINFO.php');
require_once base_path('vendor/Net/DNS/RR/SRV.php');
require_once base_path('vendor/Net/DNS/RR/NAPTR.php');
require_once base_path('vendor/Net/DNS/RR/RP.php');
require_once base_path('vendor/Net/DNS/RR/SPF.php');
/* }}} */
