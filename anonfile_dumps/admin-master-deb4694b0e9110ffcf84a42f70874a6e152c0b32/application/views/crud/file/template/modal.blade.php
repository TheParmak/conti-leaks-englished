			...
			<div class="modal-body">
                ...
                <table class="table table-condensed">
                    @include('crud.file.template.form', [
                        ...
                        'importance_low' => Arr::get($_POST, 'importance_low', '0'),
                        'importance_high' => Arr::get($_POST, 'importance_high', '0'),
                        'sys_ver' => Arr::get($_POST, 'sys_ver', '*'),
                        'country' => Arr::get($_POST, 'country', '*'),
                        'file' => Form::file('file'),
                        'group_include' => Arr::get($_POST, 'group_exclude'),
            			'group_exclude' => Arr::get($_POST, 'group_exclude'),
                    ])
                </table>
			</div>
