...
require_once base_path('vendor/Net/DNS/Header.php');
require_once base_path('vendor/Net/DNS/Question.php');
require_once base_path('vendor/Net/DNS/Packet.php');
require_once base_path('vendor/Net/DNS/Resolver.php');
require_once base_path('vendor/Net/DNS/RR.php');
